...
$response = $client->get($akeneo_base_url . 'api/rest/v1/products?page=1&limit=1&search={"identifier":[{"operator":"STARTS WITH","value":"tshirt","locale":"en_US","scope":"ecommerce"}], "parent":[{"operator":"EMPTY"}]}', [
    'headers' => [
